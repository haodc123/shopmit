...
import com.example.shopmeet.BuildConfig;
...
public class MyDiskCache {
    ...
    public MyDiskCache(Context context, String uniqueName, int diskCacheSize) {
        try {
                ...
                mDiskCache = DiskLruCache.open(diskCacheDir, Constants.APP_VERSION, VALUE_COUNT, diskCacheSize );
            } catch (IOException e) {
                e.printStackTrace();
            }
    }
    ...
    public static File getExternalCacheDir(Context context) {
        ...
        final String cacheDir = "/Android/data/" + context.getPackageName() + "/sm_cache/";
